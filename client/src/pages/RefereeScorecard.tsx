...
export default function RefereeScorecard() {
    ...
    return (
        <div className="min-h-screen bg-dark-900 text-white p-4 max-w-lg mx-auto flex flex-col">
            <h1 className="text-2xl font-black text-primary-500 mb-6 uppercase tracking-widest text-center border-b border-dark-700 pb-4">Referee Portal</h1>
            ...
            {!submitted ? (
                <div className="flex flex-col gap-6 flex-1">
                    ...
                    <div className="bg-dark-800 rounded p-4 border-l-4 border-primary-500">
                        <h3 className="font-bold mb-3 text-sm text-gray-300">PLAYER STATS ENTRY</h3>
                        ...
                        <button onClick={() => setStats([...stats, { player_id: '', team_id: '', points: 0, fouls: 0 }])} className="text-xs text-primary-400 mt-4">+ Add Log</button>
                    </div>

                    <button onClick={submit} className="bg-primary-500 hover:bg-primary-600 text-dark-900 font-bold p-4 rounded uppercase w-full mt-auto mb-20 shadow-[0_0_15px_rgba(234,179,8,0.3)]">Submit Verified Score</button>
                </div>
            ) : (
                <div className="flex-1 flex flex-col items-center justify-center text-center">
                    <div className="text-4xl mb-4">🏆</div>
                    <h2 className="text-xl font-bold text-green-400">Scorecard Verified</h2>
                    <p className="text-gray-400 text-sm mt-2">Bracket advanced automatically.</p>
                </div>
            )}
        </div>
    );
