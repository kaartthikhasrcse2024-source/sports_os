...
function isJobSchedulerRun(error) {
    return (error === null || error === void 0 ? void 0 : error.code) === JOB_BELONGS_TO_JOB_SCHEDULER;
}
async function cleanJob(_req, job, _queue) {
    var _a;
    const jobId = (_a = job.toJSON().id) !== null && _a !== void 0 ? _a : 'unknown id';
    try {
        await job.remove();
    }
    catch (error) {
        ...
        if (isJobSchedulerRun(error) && jobSchedulerId) {
            return (0, errors_1.errorResponse)(400, 'ERRORS.JOB_BELONGS_TO_JOB_SCHEDULER', {
                message: {
        ...
        if ((await job.getState().catch(() => null)) === 'active') {
            return (0, errors_1.errorResponse)(409, 'ERRORS.JOB_IS_ACTIVE', {
