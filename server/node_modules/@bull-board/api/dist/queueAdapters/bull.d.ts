...
import { AppJobScheduler, JobCleanStatus, JobCounts, JobSchedulerRepeatOptions, JobSchedulerUpdateResult, JobStatus, MetricsType, QueueAdapterOptions, QueueDefaultJobOptions, QueueJobOptions, QueueMetrics, QueueWorker, Status } from '../../typings/app';
...
export declare class BullAdapter extends BaseAdapter {
    ...
    updateJobScheduler(_id: string, _repeat: JobSchedulerRepeatOptions): Promise<JobSchedulerUpdateResult>;
